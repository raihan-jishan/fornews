...
import { SiGooglemessages } from '../utils/icons';
const ContactUs = () => {
  return (
      ...
      <div className="py-4 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <form action="#" className="space-y-8">
          <div>
            <label
              for="email"
              className="block mb-2 text-xl font-medium text-gray-900 dark:text-gray-200 "
            >
              Your email
            </label>
            <input
              type="email"
              id="email"
              className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-transparent dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
          ...
          <div className="flex text-center">
            <Button name={'Send message'} roundedFull icon={<SiGooglemessages size={35}/>}/>
          </div>
        </form>
      </div>
    </section>
