...
const RequestedNews = (props) => {
  ...
  return (
    <>
      {show && (
        // <div className="">
        //   <h1 className="m-6 text-3xl mt-5 font-Comfortaa font-semibold   flex ">
      ...
      >
        {news.map((data) => {
          return (
            <div className="grid grid-cols-3 gap-10 mb-4 mt-5 max-lg:grid-cols-1
            max-sm:flex-col max-sm:gap-3 mr-44 w-72" key={data.url}>
        ...
        {articles ? (
          <div className="flex items-center justify-end">
            <Link to={`/${props.Link}`}>
              <button className=" border-2 p-3   rounded-full text-2xl  mt-12 bg-gray-800 px-12 text-white  h-fit hover:scale-95 transition-all flex">
